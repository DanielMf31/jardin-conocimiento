---
title: "C · Módulo 08 · Ej 01 — Define Punto {x, y}, lee dos puntos del usuario e imprimelos con…"
date: 2026-08-04
...
# Ejercicio 01 — Define Punto {x, y}, lee dos puntos del usuario e imprimelos con…

Dificultad: verde · Módulo 08 (Structs)

## Enunciado

Define Punto {x, y}, lee dos puntos del usuario e imprimelos con formato (x, y).

## Diagramas de flujo

![Diagrama de flujo (actividad) del ejercicio 01](/Curso_C/practica/08-structs/ej01_plantuml.png)

![Diagrama de flujo (grafo) del ejercicio 01](/Curso_C/practica/08-structs/ej01_graphviz.png)
 ...
 * Enunciado: Define Punto {x, y}, lee dos puntos del usuario e imprimelos con formato (x, y).
 * Dificultad: verde
