---
title: "C · Módulo 09 · Ej 03 — Lee numeros.txt (enteros, uno por linea) y muestra su suma y media"
date: 2026-08-04
...
# Ejercicio 03 — Lee numeros.txt (enteros, uno por linea) y muestra su suma y media

Dificultad: amarillo · Módulo 09 (Lectura y escritura de archivos)

## Enunciado

Lee numeros.txt (enteros, uno por linea) y muestra su suma y media.

## Diagramas de flujo

![Diagrama de flujo (actividad) del ejercicio 03](/Curso_C/practica/09-archivos/ej03_plantuml.png)

![Diagrama de flujo (grafo) del ejercicio 03](/Curso_C/practica/09-archivos/ej03_graphviz.png)
...
/*
  ...
  Enunciado: Lee numeros.txt (enteros, uno por linea) y muestra su suma y media.
  Dificultad: amarillo
