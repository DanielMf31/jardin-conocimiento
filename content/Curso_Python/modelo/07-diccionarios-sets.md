...
mirror: true
mirror_source: curso-python/modelo/07-diccionarios-sets.md
---

<!-- FICHERO GENERADO — NO EDITAR. Fuente de verdad: curso-python/modelo/07-diccionarios-sets.md (se regenera con gen_course.py). -->
...
- [[Curso_Python/practica/07-diccionarios-sets/ej01|Ej 01 — Cuenta la frecuencia de cada palabra en una frase introducida por el… (verde)]]
- [[Curso_Python/practica/07-diccionarios-sets/ej02|Ej 02 — Comprueba si dos palabras son anagramas comparando sus frecuencias de… (amarillo)]]
- [[Curso_Python/practica/07-diccionarios-sets/ej03|Ej 03 — Dada una lista con duplicados, devuelve los elementos unicos usando set (verde)]]
- [[Curso_Python/practica/07-diccionarios-sets/ej04|Ej 04 — Pide dos frases al usuario y muestra las palabras que aparecen en AMBAS (amarillo)]]
- [[Curso_Python/practica/07-diccionarios-sets/ej05|Ej 05 — Two-sum basico (rojo)]]
- [[Curso_Python/practica/07-diccionarios-sets/ej06|Ej 06 — Agrupa palabras de una frase por su primera letra y muestralas ordenadas (amarillo)]]
