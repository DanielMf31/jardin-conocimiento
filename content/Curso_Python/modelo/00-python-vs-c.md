...
mirror: true
mirror_source: curso-python/modelo/00-python-vs-c.md
---

<!-- FICHERO GENERADO — NO EDITAR. Fuente de verdad: curso-python/modelo/00-python-vs-c.md (se regenera con gen_course.py). -->
