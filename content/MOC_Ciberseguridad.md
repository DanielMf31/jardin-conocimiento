...
>
> ⚖️ **Ética**: todo aquí es para **defender** y para pentesting **autorizado** (tus sistemas, labs, CTFs).
...
- 🕸️ [[Natas/00_README|OverTheWire Natas]] — **seguridad web** (OWASP) jugando: walkthroughs de los 34 niveles ⭐
...
- 🟢 [[HTB_Easy/00_README|HackTheBox máquinas Easy]] — el paso siguiente: 15 máquinas retiradas (cadena foothold→shell→privesc) + patrones
- 🟡 [[HTB_Medium/00_README|HackTheBox máquinas Medium]] — 5 ejemplos ultra-detallados (NoSQLi, polyglot, AD/Kerberoasting…) para ver cómo se encadenan
